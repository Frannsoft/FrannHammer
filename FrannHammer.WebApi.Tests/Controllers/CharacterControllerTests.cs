...
namespace FrannHammer.WebApi.Tests.Controllers
{
    ...
    //{
        ...
        //    var response = controller.Get(testCharacter.Id) as OkNegotiatedContentResult<ICharacter>;
        ...
        //    var controller = new CharacterController(new DefaultCharacterService(characterRepositoryMock.Object));
        //    var response = controller.Get(testCharacter1.Id) as OkNegotiatedContentResult<ICharacter>;
        ...
        //    var controller = new CharacterController(new DefaultCharacterService(characterRepositoryMock.Object));
        //    var response = controller.GetAll() as OkNegotiatedContentResult<IEnumerable<ICharacter>>;
