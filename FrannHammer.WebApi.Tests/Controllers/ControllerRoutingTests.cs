...
namespace FrannHammer.WebApi.Tests.Controllers
{
    ...
    public class ControllerRoutingTests
    {
        ...
        {
            yield return Tuple.Create("moves/name/{name}", typeof(MoveController), nameof(MoveController.GetByName));
        ...
        private static IEnumerable<Tuple<string, Type, string>> MovementControllerRouteInfo()
        {
            ...
            yield return Tuple.Create("movements/name/{name}", typeof(MovementController), nameof(MovementController.GetByName));
        }

        private static IEnumerable<Tuple<string, Type, string>> CharacterControllerRouteInfo()
        {
            yield return Tuple.Create("characters/name/{name}", typeof(CharacterController), nameof(CharacterController.GetByName));
        ...
        {
            yield return Tuple.Create("characterattributes/name/{name}", typeof(CharacterAttributeController), nameof(CharacterAttributeController.GetByName));
