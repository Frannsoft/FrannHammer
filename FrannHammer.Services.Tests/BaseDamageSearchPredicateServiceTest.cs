...
{
    [TestFixture]
    public class BaseDamageSearchPredicateServiceTest
    {
        private BaseDamageSearchPredicateService _service;
        private const string UnableToFindValueMessage = "Unable to find value in base damage range";
        private const string FoundValueMessage = "Found value in base damage range";

        [SetUp]
        public void SetUp()
        {
            _service = new BaseDamageSearchPredicateService();
        }
