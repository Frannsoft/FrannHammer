...
namespace FrannHammer.Domain.Tests
{
    ...
    public class BsonMapperTests
    {
        ...
        public void ExpectedPropertiesRegisterForType()
        {
            ...
            Assert.That(memberMaps[0].ElementName, Is.EqualTo(nameof(MongoModel.InstanceId)), "Id element name");
            Assert.That(memberMaps[1].ElementName, Is.EqualTo(nameof(MongoModel.Name).ToLower()), "Name element name");
        }
    }
}
